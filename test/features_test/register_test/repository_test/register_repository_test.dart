  ...
  group('RegisterRepository tests', () {
    group('Register method tests', () {
      test('returns LoginResponseModel when register is successful', () async {
        ...
        // Assert
        res.fold(
          (_) => fail('Should return Right with LoginResponseModel'),
      ...
      test('returns Failure with unexpected error message when register throws a non-AllHttpException', () async {
        // Arrange
