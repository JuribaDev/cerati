...
class __$$WebsiteResponseModelImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$WebsiteResponseModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$WebsiteResponseModelImpl implements _WebsiteResponseModel {
  const _$WebsiteResponseModelImpl(
      {required this.id,
  ...
  Map<String, dynamic> toJson() {
    return _$$WebsiteResponseModelImplToJson(
      this,
    );
  }
}
