...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  $Res call(
      {String status,
      String token,
      @JsonKey(name: 'user', includeToJson: true) UserModel userModel});
...
class _$_LoginResponseModel implements _LoginResponseModel {
  const _$_LoginResponseModel(
      ...
      required this.token,
      @JsonKey(name: 'user', includeToJson: true) required this.userModel});
...
abstract class _LoginResponseModel implements LoginResponseModel {
  const factory _LoginResponseModel(
      ...
      @JsonKey(name: 'user', includeToJson: true)
      required final UserModel userModel}) = _$_LoginResponseModel;
