...
import 'package:cerati/common/services/network_manager/test/mock_network_manager.dart'
    as _i3;
import 'package:cerati/injection.dart' as _i7;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i5.NetworkManager>(
        _i5.NetworkManager(baseUrl: gh<String>(instanceName: 'BaseUrl')));
    gh.singleton<_i6.ApiClient>(_i6.ApiClient(gh<_i5.NetworkManager>()));
    return this;
  }
}

class _$TestModule extends _i7.TestModule {}

class _$DevModule extends _i7.DevModule {}

class _$StagModule extends _i7.StagModule {}

class _$ProdModule extends _i7.ProdModule {}
